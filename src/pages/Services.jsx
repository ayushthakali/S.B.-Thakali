...
function Services() {
  return (
    <div className="w-full min-h-screen mt-20 bg-gray-100">
      ...
      <Helmet>
        <title>Our Services | S.B. Thakali & Associates</title>
        <meta
          name="description"
          content="Explore S.B. Thakali & Associates’ professional services in Accounting, Audit, Tax, Legal, and Advisory. Trusted Chartered Accountants in Pokhara, Nepal."
        />
        <meta
          name="keywords"
          content="Accounting services, Audit, Taxation, Legal services, Business Advisory, Chartered Accountant, Pokhara, Nepal"
        />
