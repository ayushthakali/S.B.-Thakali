...
function Legal() {
  ...
  return (
    <div className="w-full min-h-screen mt-20 bg-gray-100">
      <Helmet>
        <title>Legal Services | S.B. Thakali & Associates</title>
        <meta
          name="description"
          content="Commercial and corporate law services in Pokhara. Company registration, liquidation, legal documentation, and compliance by S.B. Thakali & Associates."
        />
