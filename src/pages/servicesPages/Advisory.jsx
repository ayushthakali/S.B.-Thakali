...
import advisoryPage from "../../assets/advisoryPage.jpg";
...
function Advisory() {
  ...
  return (
    <div className="w-full min-h-screen mt-20 bg-gray-100">
      <Helmet>
        <title>Advisory Services | S.B. Thakali & Associates</title>
        <meta
          name="description"
          content="Professional Advisory services in Pokhara by S.B. Thakali & Associates. Risk management, consulting, and actionable business strategies for sustainable growth."
        />
