...
function Contact() {
  return (
    <div className="w-full min-h-screen mt-20 ">
      <Helmet>
        <title>Contact | S.B. Thakali & Associates</title>
        <meta
          name="description"
          content="Get in touch with S.B. Thakali & Associates in Pokhara for Accounting, Tax, Audit, and Advisory services. We're ready to assist you."
        />
