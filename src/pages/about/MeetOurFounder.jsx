...
function MeetOurFounder() {
  return (
    <div className="w-full min-h-screen mt-20 bg-gray-100">
      <Helmet>
        <title>Meet Our Founder | S.B. Thakali & Associates</title>
        <meta
          name="description"
          content="Learn about CA Samip Bharti Thakali, Founder of S.B. Thakali & Associates, and discover his expertise in accounting, taxation, audit, and business advisory in Nepal."
        />
        <meta
          name="keywords"
          content="Samip Bharti Thakali, Founder, CA, S.B. Thakali & Associates, Accounting, Audit, Tax, Advisory, Nepal, Pokhara"
        />
        <meta name="author" content="S.B. Thakali & Associates" />
        <meta name="robots" content="index, follow" />
        <link
          rel="canonical"
          href="https://yourdomain.com/about/meetourfounder"
        />
      </Helmet>
