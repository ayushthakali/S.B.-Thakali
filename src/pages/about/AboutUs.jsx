...
function AboutUs() {
  ...
  return (
    <div className="w-full min-h-screen mt-20 bg-gray-100">
      ...
      <Helmet>
        <title>About Us | S.B. Thakali & Associates</title>
        <meta
          name="description"
          content="Learn about S.B. Thakali & Associates, a trusted accounting and advisory firm in Pokhara, Nepal. Discover our mission, values, and commitment to helping businesses thrive."
        />
        <meta
          name="keywords"
          content="About S.B. Thakali & Associates, Accounting Firm, Audit, Tax, Advisory, Chartered Accountants, Nepal, Pokhara"
        />
        <meta name="author" content="S.B. Thakali & Associates" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://yourdomain.com/about/aboutus" />
      </Helmet>
