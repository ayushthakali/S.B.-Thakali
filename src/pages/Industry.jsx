...
function Industry() {
  ...
  return (
    <div className="w-full min-h-screen mt-20 bg-gray-100">
      <Helmet>
        <title>Industries We Serve | S.B. Thakali & Associates</title>
        <meta
          name="description"
          content="Discover the industries we serve at S.B. Thakali & Associates, including Consumer, Energy, Government, IT, Healthcare, Tourism, and Infrastructure. Expert audit, tax, and advisory services tailored for each sector."
        />
        <meta
          name="keywords"
          content="Industries, Consumer Business, Energy, Government, IT, Healthcare, Tourism, Infrastructure, Accounting, Audit, Tax, Advisory, Chartered Accountants, Pokhara, Nepal"
        />
        <meta name="author" content="S.B. Thakali & Associates" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://yourdomain.com/industry" />
      </Helmet>
